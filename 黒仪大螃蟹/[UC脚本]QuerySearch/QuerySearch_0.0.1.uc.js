...
location == "chrome://browser/content/browser.xul" && (function () {
	var querySearch = {
		...
		updateMenu: function(){
			...
			if(arguments.length == 3) document.getElementById('querySearchHbox').remove();
			this.menu = null;
			var wm = new WeakMap(),
			...
			this.menu = cE('menuitem', {id: 'querySearch', flex: 1, label: this.zh ? '搜索' : 'Query Search'}, hbox);
