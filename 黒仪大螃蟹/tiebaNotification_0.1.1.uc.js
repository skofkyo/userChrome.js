					...
					var listener = {
					  observe: function(subject, topic, data) {
							if(topic == "alertclickcallback"){
								...
								var tburl = 'http://tieba.baidu.com/i/sys/jump?u='+new Date().getTime()+'&type=';
								tburl+= (reply ? "replyme" : (AtMe ? "atme" : "replyme"));
								gBrowser.loadOneTab(tburl, null, null, postData, false, false);
							}
						}
					}
