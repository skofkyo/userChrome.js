				...
				sentRequest.call(this, details, function(res){
					...
					if(td_r && ((typeof td_r == 'object') && !Array.isArray(td_r) || dictResult)){
						...
						sentRequest(details, function(res){
							...
							if(text.edict && text.edict.item && text.edict.item.length){// 英英析义
								var enxiyi = '';
