...
// @Note           [141122]添加bing, baidu翻译服务。[141123]修正baidu翻译一处错误, 一些css小调整。
// ==/FireGesturesScript==
										...
										for(var means of parts.means){
											if(Array.isArray(parts.means)){
												if(typeof means == 'string'){
													smUL += '<li class="_FgGTr-bd-sm-parts-sg">' 
															+ means + '</li>';
			...
			setStyle: function(element){
				var style = document.createElement('style'),
					cssText = (function(){/*
						...
						._FgGTr-bd-sm-parts li._FgGTr-bd-sm-parts-sg{
							margin:0 0 0 5px;
							word-wrap: normal;
						}
