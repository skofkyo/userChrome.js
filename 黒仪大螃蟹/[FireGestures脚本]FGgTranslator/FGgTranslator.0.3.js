	...
	if(!window.FGgTranslator){
		window.FGgTranslator = {
			...
			window.addEventListener("unload",this, false);
				...
				this.boxElements.box.style.top = event.clientY + window.pageYOffset-this.offset.y +"px";
				this.boxElements.box.style.left = event.clientX + window.pageXOffset-this.offset.x +"px";
